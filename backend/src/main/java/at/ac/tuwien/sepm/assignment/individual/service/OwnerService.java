...
public interface OwnerService {
  ...
  /**
   * Search for owners matching the criteria in {@code searchParameters} or all owners when
   * {@code searchParameters} is omitted
   * <p>
   ...
   * @return a stream containing owners matching the criteria in {@code searchParameters} or all owners when {@code searchParameters} is omitted
   */
