...
public class HorseMapper {
  ...
  public HorseListDto entityToListDto(Horse horse, Map<Long, OwnerDto> owners) {
    ...
    return new HorseListDto(
        ...
        horse.getFemaleParentId(),
        horse.getMaleParentId()
    );
  }
  ...
  /**
   * Returns owner from given owners map that is in relationship with given horse
   *
   * @param horse  horse
   * @param owners owners
   * @return owner that is in a relationship with given horse or null
   */
